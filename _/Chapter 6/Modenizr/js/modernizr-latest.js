...
!function (window, document, undefined) {
	...
	function testRunner() {
		...
		for (var a in tests) {
			...
			for (r = is(t.fn, "function") ? t.fn() : t.fn, o = 0; o < e.length; o++)
				i = e[o], d = i.split("."), 1 === d.length ? Modernizr[d[0]] = r : (!Modernizr[d[0]] || Modernizr[d[0]]instanceof Boolean || (Modernizr[d[0]] = new Boolean(Modernizr[d[0]])), Modernizr[d[0]][d[1]] = r), classes.push((r ? "" : "no-") + d.join("-"))
		}
	}
	function addTest(e, t) {
		if ("object" == typeof e)
			for (var n in e)
				hasOwnProp(e, n) && addTest(n, e[n]);
		else {
			e = e.toLowerCase();
			var r = e.split("."),
			o = Modernizr[r[0]];
	...
	function getBody() {
		var e = document.body;
		return e || (e = createElement(isSVG ? "svg" : "body"), e.fake = !0),
		e
	}
	function injectElementWithStyles(e, t, n, r) {
		...
		if (parseInt(n, 10))
			for (; n--; )
				d = createElement("div"), d.id = r ? r[n] : s + (n + 1), A.appendChild(d);
		return o = createElement("style"),
		o.type = "text/css",
		o.id = "s" + s,
		(l.fake ? l : A).appendChild(o),
		l.appendChild(A),
		...
		i = t(A, e),
		l.fake ? (l.parentNode.removeChild(l), docElement.style.overflow = a, docElement.offsetHeight) : A.parentNode.removeChild(A),
		!!i
	}
	...
	function testDOMProps(e, t, n) {
		...
		for (var o in e)
			if (e[o]in t)
				return n === !1 ? e[o] : (r = t[e[o]], is(r, "function") ? fnBind(r, n || t) : r);
		return !1
	}
	function nativeTestProps(e, t) {
		...
		if ("CSS" in window && "supports" in window.CSS) {
			for (; n--; )
				if (window.CSS.supports(domToCSS(e[n]), t))
					return !0;
			return !1
		}
		if ("CSSSupportsRule" in window) {
			for (var r = []; n--; )
				r.push("(" + domToCSS(e[n]) + ":" + t + ")");
			return r = r.join(" or "),
	...
	function testProps(e, t, n, r) {
		...
		for (var d, a, s, A, l, c = ["modernizr", "tspan"]; !mStyle.style; )
			d = !0, mStyle.modElem = createElement(c.shift()), mStyle.style = mStyle.modElem.style;
	...
	isSVG || !function (e, t) {
		...
		function d(e, n, r) {
			...
			r || (r = i(n));
			var o;
			return o = r.cache[e] ? r.cache[e].cloneNode() : f.test(e) ? (r.cache[e] = r.createElem(e)).cloneNode() : r.createElem(e),
		...
		function a(e, n) {
			...
			n = n || i(e);
			for (var o = n.frag.cloneNode(), d = 0, a = r(), s = a.length; s > d; d++)
				o.createElement(a[d]);
			return o
		}
		function s(e, t) {
		...
		function A(e) {
			e || (e = t);
			var r = i(e);
			return !v.shivCSS || l || r.hasCSS || (r.hasCSS = !!n(e, "article,aside,dialog,figcaption,figure,footer,header,hgroup,main,nav,section{display:block}mark{background:#FF0;color:#000}template{display:none}")),
			c || s(e, r),
			e
		}
		var l,
	...
	Modernizr.addAsyncTest(function () {
		function e() {
			clearTimeout(t),
			window.removeEventListener("deviceproximity", e),
			addTest("proximity", !0)
		}
		var t,
		n = 300;
	...
	Modernizr.addAsyncTest(function () {
		...
		try {
			...
			o || (i = new n, i.append(l), o = i.getBlob()),
			a = r.createObjectURL(o),
			d = new Worker(a),
			d.onmessage = function (e) {
				addTest("blobworkers", A === e.data),
				t()
			},
			d.onerror = e,
			s = setTimeout(e, 200),
	...
	Modernizr.addTest("emoji", function () {
		...
		r = n.getContext("2d");
		return r.fillStyle = "#f00",
		r.textBaseline = "top",
		r.font = "32px Arial",
		r.fillText("🐨", 0, 0),
		0 !== r.getImageData(t, t, 1, 1).data[0]
	}),
	...
	Modernizr.addTest("vml", function () {
		...
		t = createElement("div"),
		n = !1;
		return isSVG || (t.innerHTML = '<v:shape id="vml_flag1" adj="1" />', e = t.firstChild, e.style.behavior = "url(#default#VML)", n = e ? "object" == typeof e.adj : !0),
		n
	}),
	...
	Modernizr.addTest("csscalc", function () {
		...
		t = "calc(10px);",
		n = createElement("a");
		return n.style.cssText = e + prefixes.join(t + e),
		!!n.style.length
	}),
	...
	Modernizr.addTest("csspositionsticky", function () {
		...
		n = createElement("a"),
		r = n.style;
		return r.cssText = e + prefixes.join(t + ";" + e).slice(0, -e.length),
	...
	Modernizr.addTest("regions", function () {
		...
		d.style.cssText = "width: 50px; height: 50px; padding: 42px;",
		d.style[e] = a,
		o.appendChild(i),
		o.appendChild(d),
		...
		A = parseInt(s.left - l.left, 10),
		docElement.removeChild(o),
		42 == A ? n = !0 : (docElement.appendChild(r), l = r.getBoundingClientRect(), r.style[t] = a, s = r.getBoundingClientRect(), l.height > 0 && l.height !== s.height && 0 === s.height && (n = !0)),
		i = d = o = r = undefined,
		n
	}),
	...
	Modernizr.addTest("ruby", function () {
		function e(e, t) {
			var n;
			return window.getComputedStyle ? n = document.defaultView.getComputedStyle(e, null).getPropertyValue(t) : e.currentStyle && (n = e.currentStyle[t]),
			n
		}
		function t() {
	...
	Modernizr.addTest("formattribute", function () {
		...
		i = t.elements && 1 === t.elements.length && n.form == t,
	...
	Modernizr.addTest("fileinputdirectory", function () {
		var e = createElement("input"),
		t = "directory";
		if (e.type = "file", t in e)
			return !0;
		for (var n = 0, r = domPrefixes.length; r > n; n++)
			if (domPrefixes[n] + t in e)
				return !0;
		return !1
	}),
	...
	Modernizr.addAsyncTest(function () {
		if (Modernizr.webglextensions = new Boolean(!1), Modernizr.webgl) {
			...
			for (var o = -1, i = n.length; ++o < i; )
				Modernizr.webglextensions[n[o]] = !0;
			e = undefined
		}
	}),
	Modernizr.addAsyncTest(function () {
		function e(n) {
			clearTimeout(t),
			r.removeEventListener("playing", e, !1),
			addTest("videoautoplay", n && "playing" === n.type || 0 !== r.currentTime),
			r.parentNode.removeChild(r)
		}
		var t,
		n = 300,
		...
		docElement.appendChild(r),
		setTimeout(function () {
			r.addEventListener("playing", e, !1),
			t = setTimeout(e, n)
		}, 0)
	});
	...
	var atRule = function (e) {
		...
		if (!e)
			return !1;
		if (e = e.replace(/^@/, ""), t = e.replace(/-/g, "_").toUpperCase() + "_RULE", t in r)
			return "@" + e;
		for (var o = 0; n > o; o++) {
			var i = prefixes[o],
			d = i.toUpperCase() + "_" + t;
	...
	Modernizr.inputtypes = function (e) {
		for (var t, n, r, o = e.length, i = ":)", d = 0; o > d; d++)
			inputElem.setAttribute("type", t = e[d]), r = "text" !== inputElem.type && "style" in inputElem, r && (inputElem.value = i, inputElem.style.cssText = "position:absolute;visibility:hidden;", /^range$/.test(t) && inputElem.style.WebkitAppearance !== undefined ? (docElement.appendChild(inputElem), n = document.defaultView, r = n.getComputedStyle && "textfield" !== n.getComputedStyle(inputElem, null).WebkitAppearance && 0 !== inputElem.offsetHeight, docElement.removeChild(inputElem)) : /^(search|tel)$/.test(t) || (r = /^(url|email|number)$/.test(t) ? inputElem.checkValidity && inputElem.checkValidity() === !1 : inputElem.value != i)), inputs[e[d]] = !!r;
		return inputs
	}
	(inputtypes),
	Modernizr.addAsyncTest(function () {
		...
		if (e = !("plugins" in navigator && "Shockwave Flash" in navigator.plugins || t), e || isSVG)
			r(!1);
		else {
			var i,
			d,
			...
			s = getBody();
			if (a.type = "application/x-shockwave-flash", s.appendChild(a), docElement.appendChild(s), !("Pan" in a || t))
				return r("blocked", a), void n(s);
			i = function () {
	...
	Modernizr.addTest("unicode", function () {
		...
		return testStyles("#modernizr{font-family:Arial,sans;font-size:300em;}", function (r) {
			t.innerHTML = isSVG ? "妇" : "&#5987",
			n.innerHTML = isSVG ? "☆" : "&#9734",
			r.appendChild(t),
			r.appendChild(n),
			e = "offsetWidth" in t && t.offsetWidth !== n.offsetWidth
		}),
		e
	}),
	...
	testStyles("#modernizr{position: absolute; top: -10em; visibility:hidden; font: normal 10px arial;}#subpixel{float: left; font-size: 33.3333%;}", function (e) {
		...
		Modernizr.addTest("subpixelfont", window.getComputedStyle ? "44px" !== window.getComputedStyle(t, null).getPropertyValue("width") : !1)
	}, 1, ["subpixel"]),
	...
	Modernizr.addTest("oninput", function () {
		...
		if (t.setAttribute("oninput", "return"), hasEvent("oninput", docElement) || "function" == typeof t.oninput)
			return !0;
		try {
			...
			n.initKeyEvent("keypress", !0, !0, window, !1, !1, !1, !1, 0, "e".charCodeAt(0)),
	...
	Modernizr.addTest("formvalidation", function () {
		...
		e.addEventListener("submit", function (e) {
			window.opera || e.preventDefault(),
			e.stopPropagation()
		}, !1),
		e.innerHTML = '<input name="modTest" required><button></button>',
		testStyles("#modernizr form{position:absolute;top:-99999em}", function (r) {
			r.appendChild(e),
	...
	Modernizr.addTest("localizednumber", function () {
		...
		return e = "number" === o.type && 1.1 === o.valueAsNumber && o.checkValidity(),
		r.removeChild(t),
		n.fake && r.parentNode.removeChild(r),
		e
	});
	var mq = function () {
		...
		try {
			n.deleteDatabase(r).onsuccess = function () {
				...
				e.onsuccess = function () {
					t = e.result;
					try {
						t.transaction("store", "readwrite").objectStore("store").put(new Blob, "key"),
						o = !0
					} catch (i) {
						o = !1
					}
	...
	Modernizr.addTest("wrapflow", function () {
		...
		docElement.appendChild(n);
		var i = o.offsetLeft;
		return docElement.removeChild(n),
		r = o = n = undefined,
		150 == i
	}),
	...
	function () {
		...
		for (var e, t, n = ["Width", "Span", "Fill", "Gap", "Rule", "RuleColor", "RuleStyle", "RuleWidth", "BreakBefore", "BreakAfter", "BreakInside"], r = 0; r < n.length; r++)
			e = n[r].toLowerCase(), t = testAllProps("column" + n[r]), ("breakbefore" === e || "breakafter" === e || "breakinside" == e) && (t = t || testAllProps(n[r])), Modernizr.addTest("csscolumns." + e, t)
	}
	(),
		...
		function e() {
			function n() {
				try {
					...
					n.cssText = "position:absolute;top:0;left:0;width:5em;text-align:justify;text-justification:newspaper;",
					r = t.offsetHeight,
					o = t.offsetWidth,
					n.cssText = "position:absolute;top:0;left:0;width:5em;text-align:justify;text-justification:newspaper;" + prefixes.join("hyphens:auto; "),
					i = t.offsetHeight != r || t.offsetWidth != o,
			...
			function r(e, t) {
				try {
					...
					n.appendChild(r),
					document.body.insertBefore(n, A),
					r.innerHTML = "mm",
					i = r.offsetHeight,
					r.innerHTML = "m" + e + "m",
					a = r.offsetHeight > i,
					t ? (r.innerHTML = "m<br />m", i = r.offsetWidth, r.innerHTML = "m" + e + "m", s = r.offsetWidth > i) : s = !0,
					a === !0 && s === !0 && (d = !0),
			...
			function o(e) {
				try {
					...
					i = !1,
					d = document.body.firstElementChild || document.body.firstChild;
					if (r.innerHTML = o + e + o, document.body.insertBefore(r, d), document.body.insertBefore(n, r), n.setSelectionRange ? (n.focus(), n.setSelectionRange(0, 0)) : n.createTextRange && (t = n.createTextRange(), t.collapse(!0), t.moveEnd("character", 0), t.moveStart("character", 0), t.select()), window.find)
						i = window.find(o + o);
					else
						try {
							t = window.self.document.body.createTextRange(),
							i = t.findText(o + o)
						} catch (a) {
							i = !1
						}
	...
	Modernizr.addTest("csspseudotransitions", function () {
		...
		return Modernizr.testStyles(t, function (t) {
			window.getComputedStyle(t, ":before").getPropertyValue("font-size"),
			t.className += "trigger",
			e = "5px" === window.getComputedStyle(t, ":before").getPropertyValue("font-size")
		}),
		e
	}),
